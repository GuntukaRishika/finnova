...
import { getMonthlyExpense } from '../../api/expenseApi'
  ...
  return (
    <div className="rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
      <div className="flex items-center justify-between">
        <div>
          <p className="text-sm font-semibold uppercase tracking-[0.25em] text-rose-600">Expense Dashboard</p>
      ...
      <div className="mt-6 grid gap-4 sm:grid-cols-3">
        <div className="rounded-2xl bg-rose-50 p-4">
          <div className="flex items-center gap-2 text-rose-700">
            <FaCoins />
            <span className="text-xs font-semibold uppercase tracking-wide">Total expense</span>
          </div>
