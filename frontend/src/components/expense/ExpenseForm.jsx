...
function ExpenseForm({ categories, editingExpense, onSubmit, onCancel, isSubmitting, error }) {
      ...
      <form onSubmit={handleSubmit} className="grid gap-4 sm:grid-cols-2">
        ...
        <div className="sm:col-span-2">
          <button
            ...
            className="flex w-full items-center justify-center gap-2 rounded-2xl bg-rose-600 px-4 py-3 font-medium text-white transition hover:bg-rose-700 disabled:cursor-not-allowed disabled:opacity-70 sm:w-auto"
          >
            {editingExpense ? <FaSave /> : <FaPlus />}
